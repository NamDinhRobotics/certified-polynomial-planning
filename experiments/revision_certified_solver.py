...
def main():
    ...
    ap.add_argument('--out',type=Path,default=ROOT/'artifacts/revision_certified_solver.json')
    ...
    if args.verify_existing:
        ...
        protocol = dict(family=FAMILY,seeds=list(range(args.seeds)),steps=args.steps,
